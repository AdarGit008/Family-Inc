...
- ✅ D-032/D-044: DeepSeek wired — `lib/llm` OpenAI-compatible backend over stdlib urllib (no new dep); provider by key-presence, **keyless until the PO places `FAMILY_INC_DEEPSEEK_API_KEY`**
