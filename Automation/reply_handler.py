...
Reads Automation/inbox/replies.jsonl (written by the Baileys bridge when
Adar/Shanee reply to reminder digests), applies the commands to the
Reminders tab of Family_OS.xlsx, and sends follow-up responses via the
outbox queue.

Commands (from 02_Reminders_Engine_Spec.md §"Reply parsing"):
...
from wa_outbox import queue_message

ROOT = Path(__file__).resolve().parent
PROJECT_ROOT = ROOT.parent
SHEET_PATH = PROJECT_ROOT / "Family_OS.xlsx"
REPLIES_FILE = ROOT / "inbox" / "replies.jsonl"
PROCESSED_FILE = ROOT / "inbox" / "replies_processed.jsonl"
